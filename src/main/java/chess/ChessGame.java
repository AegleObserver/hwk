...
public class ChessGame implements GameSession {
    ...
    private TurnResult executeMove(ProcessInputInChess move) {
    ...
    private TurnResult applyAutoMove() {
        ...
        String nextMove = demoInputs.get(demoIndex);
        ProcessInputInChess move = ProcessInputInChess.parse(nextMove);
        demoIndex++;
